...
User.create(users_data = [
  ...
  Item.create(items_data = [
    ...
    {:title => "Day with Mick Jagger", :description =>"generic description", :is_available=> true,:group => 2, :category => 1, :condition => 5,:user_id => 2, :image => "http://i.imgur.com/WjGeU27.jpg"},
    ...
    {:title => "Dirtbike", :description =>"vx800 with usper cahrged booster seats", :is_available=> true,:group => 3, :category => 4, :condition => 1,:user_id => 8, :image => "http://i.imgur.com/WjGeU27.jpg"},
    ...
    {:title => "Baseball glove", :description =>"real leather brah", :is_available=> true,:group => 3, :category => 7, :condition => 2,:user_id => 10, :image => "http://i.imgur.com/WjGeU27.jpg"},
    ...
    {:title => "my guitar", :description =>"hendrix all day", :is_available=> true,:group => 3, :category => 9, :condition => 1,:user_id => 1, :image => "http://i.imgur.com/WjGeU27.jpg"},
    {:title => "defend you in a legal battle", :description =>"im a lawyer", :is_available=> true,:group => 3, :category => 10, :condition => 1,:user_id => 9, :image => "http://i.imgur.com/WjGeU27.jpg"},
    {:title => "Potted plants", :description =>"ficus and fern", :is_available=> true,:group => 3, :category => 11, :condition => 2,:user_id => 1, :image => "http://i.imgur.com/WjGeU27.jpg"},
    {:title => "cheese", :description =>"mmmm", :is_available=> true,:group => 3, :category => 12, :condition => 1,:user_id => 7, :image => "http://i.imgur.com/WjGeU27.jpg"}
