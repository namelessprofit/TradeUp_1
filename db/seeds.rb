...
Item.create(items_data = [
  {:title => "tv", :description =>"super sick cool ya", :is_available=> true,:group => "item", :category => 1, :condition => 3,:user_id => 1, :image => "https://4.bp.blogspot.com/-oVal31uHoGA/V_dXcXKf79I/AAAAAAAAAVQ/mJTZQo8kq84mOzf1jzVU5PF58-tcVBtUwCLcB/s1600/face-smile.png"},
  {:title => "radio", :description =>" best in the biz bro", :is_available=> true,:group => "item", :category => 1, :condition => 2,:user_id => 2, :image => "https://4.bp.blogspot.com/-oVal31uHoGA/V_dXcXKf79I/AAAAAAAAAVQ/mJTZQo8kq84mOzf1jzVU5PF58-tcVBtUwCLcB/s1600/face-smile.png"},
